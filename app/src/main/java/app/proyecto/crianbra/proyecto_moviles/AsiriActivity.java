...
public class AsiriActivity extends Activity {

    private String cursosCelc[]=new String[]{"Linux con Raspberry Pi","Modelado 3D + Impresora","Diseño de PCB en Eagle y Proteus",
            "MOdelado e Impresión 3D","Mantenimiento y Reparación de Computadoras", "Aplicaciones Electrónicas"};
    ...
    private String descripcion[]=new String[]{"Del 28 al 31 de Agosto","2 y 23 de Septiembre",
            ...
            "Sábado 9 y Domingo 10 de 8:00am a 13:00pm","Del 25 al 28 de Septiembre"};
